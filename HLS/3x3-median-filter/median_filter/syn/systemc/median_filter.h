...
struct median_filter : public sc_module {
    ...
    sc_signal< sc_logic > grp_bubbleSort_fu_50_ap_start;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_ap_done;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_ap_idle;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_ap_ready;
    sc_signal< sc_lv<4> > grp_bubbleSort_fu_50_inputArray_address0;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_inputArray_ce0;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_inputArray_we0;
    sc_signal< sc_lv<32> > grp_bubbleSort_fu_50_inputArray_d0;
    sc_signal< sc_lv<4> > grp_bubbleSort_fu_50_inputArray_address1;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_inputArray_ce1;
    sc_signal< sc_logic > grp_bubbleSort_fu_50_inputArray_we1;
    sc_signal< sc_lv<32> > grp_bubbleSort_fu_50_inputArray_d1;
    ...
    void thread_grp_bubbleSort_fu_50_ap_start();
    void thread_median();
